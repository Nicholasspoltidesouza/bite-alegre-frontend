...
const TextInputExample: React.FC = () => {
  ...
  return (
    ...
    <HeaderPerfilRestaurante urlFotoBanner={'https://media.discordapp.net/attachments/842552823412949003/1354653738295627936/image.png?ex=67e6131b&is=67e4c19b&hm=7427015e6d1f2178b1fb60e47b4ec1796d30bac349a019571ef36bbeafb3be85&=&format=webp&quality=lossless'}
