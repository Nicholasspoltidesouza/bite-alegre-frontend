...
const RestaurantProfilePatch = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      Alert.alert(
        'Erro',
        err instanceof Error ? err.message : 'Ocorreu um erro ao atualizar os dados'
      );
    } finally {
      setIsLoading(false);
    }
                  ...
                  <React.Fragment key={index}>
                    <View style={styles.hourRow}>
                      ...
                      >
                        ...
                        <MaterialIcons name="keyboard-arrow-down" size={16} color={Colors.orange.orangeStandard} />
                      </TouchableOpacity>
              ...
              <View style={styles.modalContent} onStartShouldSetResponder={() => true}>
                <View style={styles.modalHeader}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => setShowTimePickerModal(false)}
                  >
                    <MaterialIcons name="close" size={24} color={Colors.orange.orangeStandard} />
                  </TouchableOpacity>
                </View>
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => {
                    const isSelected = selectedDayIndex >= 0 && 
                      ((selectedTimeType === 'abertura' && operatingHours[selectedDayIndex].openTime === item) ||
                       (selectedTimeType === 'fechamento' && operatingHours[selectedDayIndex].closeTime === item));
