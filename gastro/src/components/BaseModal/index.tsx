...
type BaseModallProps = {
    visible: boolean;
    onClose: () => void;
  };
  const BaseModal: React.FC<BaseModallProps> = ({ visible, onClose }) => {
    ...
    return (
        ...
        >
          ...
          <TouchableOpacity onPress={onClose} style={styles.closeButton}>
            <AntDesign name="close" size={18} color={Colors.orange.orangeStandard} />
          </TouchableOpacity>

            <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.outlinedButton} onPress={handleLogout} >
