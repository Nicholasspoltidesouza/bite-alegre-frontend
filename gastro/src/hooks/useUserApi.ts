...
import { UserDTO, SavedRestaurantDTO } from '../@types/DTO';
...
export const useCreateUser = () => {
  ...
  return { createUser, getUserById, getUserPreferences, updateUser, saveRestaurant, deleteSavedRestaurant, loading, error, data };
};
